<?php
    ...
    function set_khach_hang($ma_kh, $mat_khau, $ho_ten, $kich_hoat, $hinh, $vai_tro, $email){
    ...
    function update_khach_hang($ma_kh, $mat_khau, $ho_ten, $kich_hoat, $hinh, $vai_tro, $email){
